...
//   // Group vulnerabilities by their associated API
// const vulnerabilitiesByApi = vulnerabilities.reduce((acc, vuln) => {
...
//   labels: Object.keys(vulnerabilitiesByApi), // API names
//   datasets: [
//     {
//       label: 'Number of Vulnerabilities',
//       data: Object.values(vulnerabilitiesByApi), // Number of vulnerabilities per API
